...
![Remote connected](images/o0N3Fxn.png)
...
![Source file tree](images/7gJo6sk.png)
...
![Cmake buttons](images/j4jepqq.png)
...
![Jupyter server](images/FVG8FUR.png)
...
![Jupyter kernel](images/NUT6DmJ.png)
...
![Docker Desktop config](images/lCykJbE.png)
...
```
cd python
ffmpeg -y -f image2 -r 14 -i plots/%05d.png -c:v h264 -crf 18 -vf "pad=ceil(iw/2)*2:ceil(ih/2)*2" -pix_fmt yuv420p phase_space.mp4
```
